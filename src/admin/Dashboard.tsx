        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-earth-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-semibold text-forest-900 mt-1">124</h3>
            </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-earth-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-semibold text-forest-900 mt-1">82%</h3>
            </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-earth-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-semibold text-forest-900 mt-1">12</h3>
            </div>
            <div className="w-12 h-12 bg-earth-100 rounded-full flex items-center justify-center text-earth-600">
          ...
          <div className="mt-4 flex items-center text-sm">
            <span className="text-forest-700/50">Requires attention</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white p-6 rounded-2xl shadow-sm border border-earth-100">
          <div className="flex items-center justify-between mb-6">
            ...
            <select className="text-xs font-medium text-forest-700 bg-earth-50 border-none rounded-lg px-3 py-1.5 outline-none">
